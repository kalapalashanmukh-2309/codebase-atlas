/**
 * Scratch test: run the updated Q&A pipeline with referencedFiles JSON extraction.
 */
import {
  parseGitHubUrl,
  fetchRepoTree,
...
const QUESTION = "Where is component state and rendering logic defined?";
...
async function main() {
  ...
  console.log("\n--- Referenced Files Array ---");
  console.log(result.referencedFiles);
}
